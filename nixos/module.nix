...
# Transforms TOML (received via specialArgs) to config.nixoa.* options
{ lib, nixoaCfg ? {}, ... }:
...
{
  # ==========================================================================
  # Set all nixoa.* configuration values from TOML (via specialArgs)
  # ==========================================================================
  ...
  config.nixoa = {
    ...
    services.definitions =
      let
        ...
        rawServicesConfig = if builtins.hasAttr "services" nixoaCfg
                            then builtins.removeAttrs nixoaCfg.services ["enable"]
                            else {};
