...
- Hardware configuration is imported by nixoa-ce
...
This file contains your machine-specific hardware settings (disks, filesystems, network interfaces, boot loader). It's generated by `nixos-generate-config` and needs to be in this repo so nixoa-ce can import it.
